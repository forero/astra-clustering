...
drive the environment-leg $C_{\rm emu}$ \emph{below} cosmic variance (it is
$\sim$2.65$\times$ after CV-weighting); each factor below CV converts into ASTRA
value-add. Routes: (1) the full \code{c130}--\code{c181}$\times$100$\times$10 campaign
