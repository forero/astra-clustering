...
\caption{Broad-prior recovery of \code{c130} over six parameters (dashed black $=$
truth). Red: synthetic mock --- recovers within $1\sigma$ at $\chi^2/{\rm dof}=0.34$,
validating the machinery over the $w_0w_a$CDM$+$ subspace. Blue: real \code{c130}
($\chi^2/{\rm dof}=1.72$) --- $\omega_{\rm cdm},h$ recovered, $w_a$ loose
(monopole-only cannot constrain the dark-energy EoS).}
